...
import com.example.ue5analyzer.ui.screens.HistoryScreen
import com.example.ue5analyzer.ui.screens.ObjPreviewScreen
...
fun MainScreen(
    ...
    val showBottomBar = when (currentDestination?.route) {
        ...
        Screen.ObjPreview.route -> false
        Screen.History.route -> false
        else -> true
    }
        ...
        NavHost(
            ...
            composable(Screen.Scan.route) {
                ScanScreen(
                    ...
                    onObjPreviewClick = {
                        navController.navigate(Screen.ObjPreview.route)
                    },
                    onHistoryCompareClick = {
            ...
            composable(Screen.ObjPreview.route) {
                ObjPreviewScreen(
                    onBackClick = { navController.popBackStack() }
                )
            }
